...
| [`infra/ansible`](./infra/ansible) | Everything after that. Makes the first-boot settings permanent (`00-host.yml`) and forms the cluster `pve` on `pve-01` (`01-cluster.yml`). Idempotent, re-run after every upgrade. |
